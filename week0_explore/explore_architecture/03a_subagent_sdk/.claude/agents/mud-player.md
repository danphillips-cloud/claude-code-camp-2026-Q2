...
description: >-
  ...
  says "play the MUD" — this agent will autonomously work toward the goal using
...
The `data/` folder sits next to this agent file. When you `cd` into
`.claude/agents/` to run `scripts/mud.py`, use the relative path `data/player.md`
or `data/world.md`. From agent code outside that directory, use the full paths above.
